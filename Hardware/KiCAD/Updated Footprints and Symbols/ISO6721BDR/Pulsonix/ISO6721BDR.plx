...
//13661089/1822976/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "ISO6721BDR" (originalName "ISO6721BDR")
	...
	(compDef "ISO6721BDR" (originalName "ISO6721BDR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "3" (pinName "INB") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "7" (pinName "INA") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "OUTB") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "GND2") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ISO6721BDR"))
		...
		(attr "Mouser Part Number" "595-ISO6721BDR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/ISO6721BDR?qs=eP2BKZSCXI7%2FRQwMzsUPCg%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "ISO6721BDR")
		(attr "Description" "ISO672x General Purpose Dual Channel Digital Isolators with Robust EMC")
		(attr "<Hyperlink>" "https://www.arrow.com/en/products/iso6721bdr/texas-instruments")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "ISO6721BDR.stp")
