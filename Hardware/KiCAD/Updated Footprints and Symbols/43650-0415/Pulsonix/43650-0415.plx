...
//300276/1822976/2.50/4/2/Connector
...
(library Library_1
	...
	(patternDef "43650-04YY_151617" (originalName "43650-04YY_151617")
		(multiLayer
			...
			(pad (padNum 5) (padStyleRef c127_h127) (pt 3, -1.96) (rotation 90))
			(pad (padNum 6) (padStyleRef c127_h127) (pt -12, -1.96) (rotation 90))
		)
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 0, 0) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -12.325 3.1) (pt 3.325 3.1) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.325 3.1) (pt 3.325 -2.47) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.325 -2.47) (pt -12.325 -2.47) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -12.325 -2.47) (pt -12.325 3.1) (width 0.025))
		)
		(layerContents (layerNumRef 18)
			(line (pt -12.325 3.1) (pt 3.325 3.1) (width 0.127))
		)
		(layerContents (layerNumRef 18)
		...
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -13.8542 4.37) (pt 4.8542 4.37) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 4.8542 4.37) (pt 4.8542 -3.8142) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 4.8542 -3.8142) (pt -13.8542 -3.8142) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -13.8542 -3.8142) (pt -13.8542 4.37) (width 0.05))
		)
	)
	(symbolDef "43650-0415" (originalName "43650-0415")
	...
	(compDef "43650-0415" (originalName "43650-0415") (compHeader (numPins 4) (numParts 1) (refDesPrefix J)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "43650-0415"))
		(attachedPattern (patternNum 1) (patternName "43650-04YY_151617")
			(numPads 4)
			(padPinMap
		...
		(attr "Mouser Part Number" "538-43650-0415")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Molex/43650-0415?qs=GEJyObWCoZgrB2DNhHHwDQ%3D%3D")
		(attr "Manufacturer_Name" "Molex")
		(attr "Manufacturer_Part_Number" "43650-0415")
		(attr "Description" "Micro-Fit 3.0 Vertical Header, 3.00mm Pitch, Single Row, 4 Circuits, with PCB Polarizing Peg, Glow-Wire Capable, Black")
		(attr "<Hyperlink>" "https://www.molex.com/pdm_docs/sd/436500215_sd.pdf")
		(attr "<Component Height>" "9.9")
		(attr "<STEP Filename>" "43650-0415.stp")
		(attr "<STEP Offsets>" "X=-4.5;Y=0.07;Z=4.97")
