...
(library Library_1
	...
	(compDef "ISO6721BDR" (originalName "ISO6721BDR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "3" (pinName "INB") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "7" (pinName "INA") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "OUTB") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://www.arrow.com/en/products/iso6721bdr/texas-instruments")
		(attr "Height" "1.75 mm")
	)
